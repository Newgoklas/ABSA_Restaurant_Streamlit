...
with col1:
    ...
    # Get example from session state if available
    ...
    if review.strip() == "":
        ...
        with st.spinner("🔄 Menganalisis review..."):
            ...
            if len(hasil) > 0:
                ...
                with col2:
                    ...
                    for sentiment, count in sentiment_counts.items():
                        if sentiment.lower() == 'positive':
                            ...
                            emoji = '⚪'
                        st.markdown(f"{emoji} **{sentiment}**: {count} aspek")
                    
                    # Total aspects
                    st.markdown(f"**Total Aspek**: {len(hasil)}")
                    ...
                    fig = go.Figure(data=[go.Pie(
                        ...
                        hole=0.4,
                        marker_colors=['#4CAF50', '#FF5252', '#9E9E9E']
                    )])
                    fig.update_layout(
                        height=250,
                ...
                # Show words with tags in a more visual way
                words, tags = predict_ner(review)
